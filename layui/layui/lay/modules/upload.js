    ...
    function (e) {
        ...
        p.prototype.config = {
            ...
            p.prototype.file = function () {
                var e = this,
                    i = e.config,
                    n = e.elemFile = t(['<input id="file" class="' + u + '" type="file" accept="' + i.acceptMime + '" name="' + i.field + '"', i.multiple ? " multiple" : "", ">"].join("")),
            ...
            p.prototype.upload = function (e, i, qf) {
                var n, o = this,
                    l = o.config,
                    r = o.elemFile[0],
                    u = function () {
                        ...
                        layui.each(a,
                            function (e, a) {
                                ...
                                r.append(l.field, a),
                                    ...
                                    t.ajax({
                                        url: l.url,
                                        xhr: l.xhr(function (el) {
                                            var percent = Math.floor((el.loaded / el.total) * 100);
                                            l.progress(e, percent);
                                        }),
                                        type: "post",
                                        data: r,
                                        contentType: !1,
                    ...
                    c = function () {
                        ...
                        o.elemFile.parent().submit(),
                            ...
                            p.timer = setInterval(function () {
                                ...
                                try {
                                    t = i.text();
                                    proPercent = proPercent + Math.random() * 10 | 0;
                                    if (proPercent > 99)
                                        proPercent = 99;
                                    l.progress && l.progress("", proPercent);
                                } catch (n) {
                    ...
                    y = function () {
                        if ("choose" !== i && !l.auto || (l.choose && l.choose(g, qf), "choose" !== i)) return l.before && l.before(g),
