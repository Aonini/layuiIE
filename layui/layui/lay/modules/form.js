...
layui.define("layer", function (e) {
                            ...
                            if (!u) {
                                ...
                                f && k.on("keyup", q).on("blur", function (i) {
                                    ...
                                    var e = t(this),
                                        a = e.attr("lay-value"),
                                        n = p.attr("lay-filter");
                                    return !e.hasClass(c) && (e.hasClass("layui-select-tips") ? k.val("") : (k.val(e.text()), e.addClass(s)), e.siblings().removeClass(s), p.val(a).removeClass("layui-form-danger"),p.parent().removeClass("isie8Border"), layui.event.call(this, l, "select(" + n + ")", {
                                        elem: p[0],
                                        value: a,
                                        othis: i
                                    }), w(!0), !1)
    ...
    var d = function () {
                $(".layui").parent().css("border","none")
            var e = t(this),
                a = f.config.verify,
                s = null,
                o = "layui-form-danger",
                pc = "isie8Border",//ie8下面红框不标红
                c = {},
                u = e.parents(r),
                d = u.find("*[lay-verify]"),
                v = e.parents("form")[0],
